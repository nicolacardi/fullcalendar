...
import it from '@fullcalendar/core/locales/it';               //fullcalendar - per la lingua
import { FullCalendarComponent } from '@fullcalendar/angular';//fullcalendar

import {MatDialog, MAT_DIALOG_DATA, MatDialogRef} from '@angular/material/dialog';    //material
import { AngularFirestore, AngularFirestoreDocument} from '@angular/fire/firestore';  //firestore
import { Observable } from 'rxjs';                                                    //rxjs
import { map } from 'rxjs/operators'                                                  //rxjs

import { environment } from '../../environments/environment'  //impostazioni ambiente

import { EventType } from '../models/models'               //interface EventType
...
export class CalendarComponent implements AfterViewInit {
  ...
  eventResizeStop(event) {
    ...
    //non funziona: da studiare eventResize di fullcalendar per capire come fare
